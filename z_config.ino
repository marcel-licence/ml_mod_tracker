...
struct midiControllerMapping edirolMapping[] =
{
    ...
    /* transport buttons */
    { 0x8, 0x52, "back", NULL, Tracker_Restart, 0},
    { 0xD, 0x52, "stop", NULL, Tracker_Stop, 0},
    { 0xe, 0x52, "start", NULL, Tracker_Start, 0},
    { 0xa, 0x52, "rec", NULL, Tracker_Step, 0},
    ...
    { 0x0, 0x51, "B1", NULL, Tracker_ToggleMute, 0},
    { 0x1, 0x51, "B2", NULL, Tracker_ToggleMute, 1},
    { 0x2, 0x51, "B3", NULL, Tracker_ToggleMute, 2},
    { 0x3, 0x51, "B4", NULL, Tracker_ToggleMute, 3},
    ...
    /* rotary */
    { 0x0, 0x10, "R1", NULL, Tracker_SetTempo, 0},
    { 0x1, 0x10, "R2", NULL, Tracker_SetPitch, 0},
